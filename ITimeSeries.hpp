 ...
 * <li> Splitting and Reshaping Time Series Data into Training and Validation
 * datasets.
 * </ul>
 */
class ITimeSeries
...
public:
   ...
   */
  virtual bool loadTimeSeries(const std::string &, const size_t &) = 0;
  /**
   * @brief Abstract method utilized for normalizing time series data
   */
  virtual void normalizeData() = 0;
  /**
   * @brief Abstract method utilized for splitting and reshaping time series
   * data
   */
