 ...
 * @brief A list of configurable constants used for LSTM neural network creation
 * and training.
 */
namespace NetworkConstants
{
  ...
  /**
   * @brief Number of previous stock prices to be used to precidict/train the next
   * stock prices
   */
  ...
  /**
   * @brief The percentage of data needed for test/validation data set from entire
   * dataset
   */
