...
namespace
{
  ...
  template <class Body, class Allocator, class Send, typename StockRequest>
  ...
  public:
    ...
    session(tcp::socket &&socket,
        ...
        : stream_(std::move(socket)), doc_root_(doc_root),
          stockPredictor_(stockPredictor), lambda_(*this) {}
  ...
  private:
    ...
    void on_accept(beast::error_code ec, tcp::socket socket)
    {
      ...
      else
      {
        ...
        std::make_shared<session>(std::move(socket), doc_root_, stockPredictor_)
            ->run();
      }
